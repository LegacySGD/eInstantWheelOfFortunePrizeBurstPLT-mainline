...
public class WheelOfFortunePrizeBurstPLTEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(WheelOfFortunePrizeBurstPLTEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/WheelOfFortunePrizeBurstPLTIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/WheelOfFortunePrizeBurstPLTIW/InitOutcome.xml").getDocumentElement();
